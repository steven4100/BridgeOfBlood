...
[BurstCompile]
public struct ShockedDecideJob : IJobParallelFor
{
    ...
    public void Execute(int i)
    {
        ...
        {
            Decisions[i] = StatusAilmentFlag.Shocked;
            return;
        }

        var rng = Unity.Mathematics.Random.CreateFromIndex(Seed + (uint)i);
        Decisions[i] = rng.NextFloat() < applier.applyChance ? StatusAilmentFlag.Shocked : StatusAilmentFlag.None;
    }
}
